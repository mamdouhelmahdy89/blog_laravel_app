                ...
                <tbody>
                    ...
                    @foreach ($posts as $item)
                        <tr>
                            ...
                            <td>
                                <a class="text-success" href="{{ route('post.restore' , ['id' => $item->id]) }}"><i class="fa-solid fa-2x fa-arrow-rotate-left"></i></a>&nbsp;

                                <a class="text-danger" href="{{ route('post.hdelete' , ['id'=> $item->id]) }}"><i class="fa-solid fa-2x fa-trash"></i></a>
                            </td>
                        </tr>
                    @endforeach
